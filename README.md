    ...
    <div class="container">
        ...
        <div class="dashboard-container" id="dashboard-container">
            <div class="dashboard-header">
                ...
                <div class="dashboard-actions">
                    ...
                    <button class="btn btn-outline" id="dashboard-logout">Logout</button>
                </div>
            </div>
                ...
                <div class="product-detail-info">
                    ...
                    <div class="reviews-section">
                        ...
                        <div class="review-form" id="review-form">
                            ...
                            <textarea class="review-text" id="review-text" placeholder="Share your experience with this product"></textarea>
        ...
        <div class="cart-container" id="cart-container">
            ...
            <div class="cart-total">
                ...
                <div>
                    <span>Shipping: </span>
                    <span id="cart-shipping-amount">$0.00</span>
                </div>
                <div>
                    <strong>Total: </strong>
            ...
            <form class="checkout-form" id="checkout-form">
                ...
                <div class="form-group form-group-full">
                    ...
                    <div class="payment-methods">
                        ...
                        <div class="payment-method" data-method="mobile-banking">
                ...
                <div class="payment-instructions" id="mobile-banking-instructions">
                ...
                <!-- bKash Instructions -->
                <div class="payment-instructions" id="bkash-instructions">
                    ...
                    <ol>
                        ...
                        <li>Enter the amount: $<span id="bkash-amount">0.00</span></li>
                        <li>Enter reference: ORDER-<span id="bkash-reference">0000</span></li>
                        <li>Enter your bKash PIN to confirm</li>
                    </ol>
                    <div class="form-group">
                        <label for="bkash-transaction">bKash Transaction ID</label>
                        <input type="text" id="bkash-transaction" placeholder="Enter your transaction ID">
                    </div>
                </div>
                
                <!-- Nagad Instructions -->
                <div class="payment-instructions" id="nagad-instructions">
                    <h4>How to pay with Nagad</h4>
                    <ol>
                        ...
                        <li>Enter reference: ORDER-<span id="nagad-reference">0000</span></li>
                        <li>Enter your Nagad PIN to confirm</li>
                    </ol>
                    <div class="form-group">
                        <label for="nagad-transaction">Nagad Transaction ID</label>
                        <input type="text" id="nagad-transaction" placeholder="Enter your transaction ID">
                    </div>
                </div>
    ...
    <script>
        ...
        const products = [
            ...
            },
            {
                ...
                name: "Summer Dress",
                price: 59.99,
                image: "https://images.unsplash.com/photo-1583744946564-b52ae1c685c7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8d29tZW4lMjBkcmVzc3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60",
        ...
        const mobileBankingInstructions = document.getElementById('mobile-banking-instructions');
        ...
        function init() {
            ...
            submitReview.addEventListener('click', handleReviewSubmit);
            ...
            document.querySelectorAll('.payment-method').forEach(method => {
                method.addEventListener('click', function() {
                    ...
                    if (methodType === 'mobile-banking') {
                        mobileBankingInstructions.classList.add('active');
                    } else if (methodType === 'bkash') {
                        bkashInstructions.classList.add('active');
                        // Generate random reference number
                        document.getElementById('bkash-reference').textContent = Math.floor(1000 + Math.random() * 9000);
                        document.getElementById('bkash-amount').textContent = document.getElementById('checkout-total-amount').textContent.replace('$', '');
                    } else if (methodType === 'nagad') {
                        nagadInstructions.classList.add('active');
                        // Generate random reference number
                        document.getElementById('nagad-reference').textContent = Math.floor(1000 + Math.random() * 9000);
                        document.getElementById('nagad-amount').textContent = document.getElementById('checkout-total-amount').textContent.replace('$', '');
                    }
                });
            });
        ...
        function toggleReviewForm() {
            ...
            if (!hasPurchased) {
                showMessage('You need to purchase this product before reviewing it', 'error');
                return;
            }
        ...
        function loadProductReviews(productId) {
            ...
            productReviews.sort((a, b) => b.id - a.id);
        ...
        function renderCartItems() {
            ...
            document.getElementById('cart-shipping-amount').textContent = `$${shipping.toFixed(2)}`;
        ...
        function openCheckout() {
            ...
            // Hide all payment instructions initially
            document.querySelectorAll('.payment-instructions').forEach(inst => {
                inst.classList.remove('active');
            });
        }
        ...
        function renderCheckoutSummary() {
            ...
            `;
            summary.appendChild(shippingItem);
        ...
        function completePurchase() {
            ...
            const order = {
                ...
                date: new Date().toLocaleDateString(),
                items: [...cart],
                total: cart.reduce((sum, item) => sum + (item.price * item.quantity), 0) + 5.99, // Include shipping
                status: 'Processing'
            };
        ...
        function handleLogin(e) {
            ...
            simulateBackendAuth('login', { email, password })
                .then(user => {
                    currentUser = user;
        ...
        function handleSignup(e) {
            ...
            simulateBackendAuth('register', { name, email, password })
                .then(user => {
                    currentUser = user;
                    localStorage.setItem('currentUser', JSON.stringify(user));
        ...
        // Simulate backend authentication
        function simulateBackendAuth(action, data) {
